	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				<li><?php echo $this->Html->link('Category', array('controller' => 'ledcategories', 'action' => 'index', 'admin' => true)); ?></li>
				<li><?php echo $this->Html->link('Bulbsizes', array('controller' => 'bulbsizes', 'action' => 'index', 'admin' => true)); ?></li>
				<li><?php echo $this->Html->link('Position', array('controller' => 'positions', 'action' => 'index', 'admin' => true)); ?></li>
